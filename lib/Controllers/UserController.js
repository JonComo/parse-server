      ...
      this.config.database.find('Priv', {
        ...
        if (results.length != 1) {
          ...
          (function () {
            ...
            _this3.config.database.update('_User', { objectId: priv['userId'] }, { email: email }, {}, true).then(function (results) {
              return _this3.config.database.update('_User', { objectId: priv['userId'] }, { _perishable_token: (0, _cryptoUtils.randomString)(25) }, {}, true);
            });
          })();
        }
      });
