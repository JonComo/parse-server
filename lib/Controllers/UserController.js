    ...
    value: function setPasswordResetToken(email) {
      ...
      this.config.database.find('Priv', {
        ...
        if (results.length != 1) {
          ...
          _this3.config.database.update('_User', { objectId: priv['userId'] }, { email: email }, {}, true);

          return Promise.resolve(_this3.config.database.update('_User', { objectId: priv['userId'] }, { _perishable_token: (0, _cryptoUtils.randomString)(25) }, {}, true));
        }
      });
    }
  }, {
